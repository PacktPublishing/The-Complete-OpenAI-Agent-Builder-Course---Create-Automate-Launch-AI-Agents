...
export const runWorkflow = async (workflow: WorkflowInput) => {
  return await withTrace('RAG - FAQ and Retention Agents - Final', async () => {
    const state = {};
    ...
    const runner = new Runner({
      traceMetadata: {
        ...
        workflow_id: 'wf_68ed315e657881909827d5d791b63463056d82b86cd9a2fa',
      },
    });
    ...
    if (guardrailsHastripwire) {
      ...
      if (
        classificationAgentResult.output_parsed.classification == 'return_item'
      ) {
